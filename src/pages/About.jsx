const About = () => {
    return (
        <div id="about" className="bg-[rgb(0,0,25)] text-[#ffffff] text-center desktop:p-[40px] smartphone:p-[20px]">
            <p className="desktop:text-[40px] smartphone:text-[30px]">About me</p>
