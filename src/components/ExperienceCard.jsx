...
const ExperienceCard = ( { company, role, date, description, certificate } ) => {
    return(
        <div className="flex flex-col bg-element-light dark:bg-element-dark p-[30px] border-r-[4px] border-b-[4px] border-azul rounded-[10px] gap-[5px] desktop:w-[500px] smartphone:w-[300px] smartphone-r:w-[460px] tablet:w-[300px]">
